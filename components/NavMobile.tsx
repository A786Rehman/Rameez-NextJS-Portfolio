...
const NavMobile = ({closeNav,showNav}:Props) => {
  ...
  return (
      ...
      ><div/>
        <ul
          className={`text-white ${navOpenStyle} fixed flex items-center flex-col justify-center h-[100%] transform transition-all duration-300 delay-300 w-[60%] bg-gray-600 space-y-14 z-[10006]`}
        >
          <li>
